...
namespace ReactMusicStore.Core.Data.Context.Config
{
    public abstract partial class BaseDbContext : DbContext, IDbContext
    {
        ...
        /// </summary>
        protected BaseDbContext() : this(GetConnectionString(), null)
        {
        }
        protected BaseDbContext(string nameOrConnectionString, int? currentUserId = null) : base(nameOrConnectionString)
        {
        ...
        public static string GetConnectionString()
        {
            ...
            // return DataSettings.LoadConnectionString();
        }
